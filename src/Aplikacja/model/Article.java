...
public class Article {
    ...
    public Article(Article article) {
        ...
        this.timestamp = new Timestamp(article.timestamp.getTime());
        this.user = new User(article.user);
        this.upVote = article.upVote;
        this.downVote = article.downVote;
    }
    ...
    public String toString() {
        return "Article [id=" + id + ", name=" + name + ", description=" + description + ", url="
