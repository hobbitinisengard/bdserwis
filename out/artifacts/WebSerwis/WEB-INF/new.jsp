...
<html>
  <head>
    <title>WebSerwis - Dodaj nowe treści</title>
    ...
    <div class="container">
        <div class="col-md-8 col-md-offset-2">
            <form class="form-signin" method="post" action="add">
                <h2 class="form-signin-heading">Dodaj nowy artykuł</h2>
                <input name="inputName" type="text" class="form-control" placeholder="Tytuł"
                    required autofocus />
